...
<div class="jumbotron text-center" style='padding: 0px';background-color:#fff>
 <div class="row" style="background-color:#fff;width:100%;margin:auto;">
    ...
    <div class="row-sm-4" style='background-color: #fff; border-radius: 5px'>
      ...
      <p style='text-align: center; font-size: 35px; font-weight: bold; color: black'>''' + str(Total_Death)+ '''</p>
    </div>
    <div class="row-sm-4">
      ...
      <p style='text-align: center ; font-size: 35px; font-weight: bold; color: green'>''' + str(Total_Recovered) + '''</p>
     </div>
     <div class="row-sm-4">
