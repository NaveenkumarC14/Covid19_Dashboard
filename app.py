...
st.markdown('''
            <div style="height:150px;width: 2%; background-color: white; float:left;left: 1500px; border-radius: 2px;"">
                    ...
                    <div>
		     <div style="height:100px;width: 22%; background-color: red; float:left; left: 1700px; border-radius: 20px; border: 2px solid #d9d9d9; border-right: right;">
            ...
            <div style="height:150px;width: 2%;background-color: white; float:left; left: 200px; border-radius: 2px;">
                    ...
                    <div>
			<div style="height:100px;width: 22%; background-color: blue; float:left; left: 1500px; border-radius: 20px; border: 2px solid #d9d9d9; border-right: right;">
		...
		<div style="height:150px;width: 2%; background-color: white; float:left;left: 300px; border-radius: 2px;"">
                    ...
                    <div>
		    <div style="height:100px;width: 22%; background-color: green; float:left; left: 1400px; border-radius: 20px; border: 2px solid #d9d9d9; border-right: right;">
