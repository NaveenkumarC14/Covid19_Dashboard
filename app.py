...
<div class="jumbotron text-center" style='padding: 0px';background-color:#fff>
 <div class="row" style="background-color:#fff;width:100%;margin:auto;">
    <div class="row-sm-4">
      <p style='text-align: center; background-color: #fff; font-weight: 200 ;color: red'>Total Confirmed</p>
      <p style='text-align: center; font-size: 15px; color: red'>[''' + str(Total_Confirmed) + ''']</p>
      <p style='text-align: center; font-size: 25px; font-weight: bold; color: red'>''' + str(Total_Confirmed) + '''</p>
    </div>
    <div class="row-sm-4" style='background-color: #fff; border-radius: 5px'>
      <p style='text-align:center; font-weight: 200 ; color: black'>Total Deaths</p>
      <p style='text-align: center; font-size: 15px; color: black'>[''' + str(Total_Death) + ''']</p>
      <p style='text-align: center; font-size: 25px; font-weight: bold; color: black'>''' + str(Total_Death)+ '''</p>
    </div>
    <div class="row-sm-4">
      <p style='text-align: center; background-color: #fff; font-weight: 200 ;color: green'>Total Recovered</p>
      <p style='text-align: center; font-size: 15px; color: green'>[''' + str(Total_Recovered) + ''']</p>
      <p style='text-align: center ; font-size: 25px; font-weight: bold; color: green'>''' + str(Total_Recovered) + '''</p>
     </div>
     <div class="row-sm-4">
      <p style='text-align: center; background-color: #fff; font-weight: 200 ;color: blue'>Total Active</p>
      <p style='text-align: center; font-size: 15px; color: blue'>[''' + str(Total_Active) + ''']</p>
      <p style='text-align: center ; font-size: 25px; font-weight: bold; color: blue'>''' + str(Total_Active) + '''</p>
     </div>
  </div>
</div>
 ''', unsafe_allow_html=True);
